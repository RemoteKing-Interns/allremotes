...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login({ id: response.data.id, email: response.data.email, name: response.data.name, role: response.data.role });
      ...
      <div className="container py-16">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-black mb-2 tracking-tight" style={{ fontFamily: 'Chivo, sans-serif' }} data-testid="register-title">
              Create Account
            </h1>
            <p className="text-text-secondary">Join All Remotes today</p>
          </div>
