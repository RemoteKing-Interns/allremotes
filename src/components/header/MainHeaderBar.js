        ...
        <div className="flex flex-wrap items-center gap-3 py-3.5 sm:gap-4 md:gap-6 md:py-4">
          <Link href="/" className="shrink-0" aria-label="ALLREMOTES home">
            <img
              ...
              alt="ALLREMOTES"
              className="h-10 w-auto sm:h-12 2xl:h-14"
            />
          </Link>

          <div
            className="order-3 relative basis-full 2xl:order-none 2xl:mx-auto 2xl:flex-1 2xl:max-w-2xl"
            ref={searchRef}
          >
          ...
          <div className="ml-auto flex flex-wrap items-center justify-end gap-2 sm:gap-3 max-[359px]:w-full max-[359px]:justify-between">
            ...
            <button
              ref={hamburgerRef}
              className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-neutral-200 bg-white/80 text-neutral-800 shadow-sm transition hover:bg-neutral-100 2xl:hidden"
              onClick={openDrawer}
