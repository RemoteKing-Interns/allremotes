        ...
        <form onSubmit={handleSaveProfile} className="account-form">
          <div className="form-group-photo">
            ...
            <div className="photo-upload">
              ...
              />
              <button type="button" className="btn btn-outline" onClick={() => document.querySelector('.file-input').click()}>
                Change Photo
              </button>
            </div>
          </div>
        ...
        <div className="security-section">
          ...
          <div className="login-history">
            ...
            <div className="login-item">
              <div>
                <p className="login-device">Chrome on Windows</p>
                <p className="login-time">Today at 2:30 PM</p>
              </div>
              <span className="login-status current">Current Session</span>
            </div>
            <div className="login-item">
              <div>
                <p className="login-device">Safari on Mac</p>
                <p className="login-time">Yesterday at 10:15 AM</p>
              </div>
              <span className="login-status">Active</span>
            </div>
          </div>
        </div>
      </div>
