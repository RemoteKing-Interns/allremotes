...
const Home = () => {
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              <Link to={hero.secondaryCtaPath || '/products/garage'} className="btn btn-hero-secondary">
                {hero.secondaryCta || 'Shop Garage Remotes'}
              </Link>
              <Link to={hero.primaryCtaPath || '/products/car'} className="btn btn-hero-primary">
  ...
  {(f.image || featureImagesByTitle[f.title]) ? (
    ...
    f.icon || '✓'
                ...
                <p>{f.description || ''}</p>
                {f.path && f.linkText && (
                  <Link to={f.path} className="feature-link">{f.linkText}</Link>
                )}
              </div>
            ))}
          </div>
      ...
      <section className="cta-section" style={{ backgroundImage: `url(${heroImg2})` }}>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <Link to={cta.buttonPath || '/products/all'} className="btn btn-hero-primary btn-large">
